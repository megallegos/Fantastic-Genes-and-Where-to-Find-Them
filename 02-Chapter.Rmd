...
<br>
To summarize . . . while DNA is double-stranded, RNA transcripts are single-stranded and thus use only one DNA strand as template (either the plus or minus strand). Some genes, like BBS1, use the plus strand as template to create an RNA transcript with a sequence that matches the top strand. Other genes, like ZDHHC24, use the plus-strand as template to create an RNA transcript with a sequence that matches the minus-strand.  
