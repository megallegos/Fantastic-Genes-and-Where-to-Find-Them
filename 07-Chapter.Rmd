# *Finding Genes with Orthology* {#chapter7}
...
## Retrieving gene product sequences 

To perform a reciprocal best hit analysis, you need the protein sequence. Click on the gene schematic in the “Gene and Gene Predictions track”. This action will open a page that provides many useful links including links to view and analyze the mRNA and protein sequences (Figure \@ref(fig:geneinfo)). Do this for BBS1.  
...
### [Test Your Understanding](https://docs.google.com/forms/d/e/1FAIpQLSdwowGrryhKSzoqOCjXO2QxHEBQPqk7A6qe8f_NR_oTpPp5sg/viewform?usp=publish-editor){target="_blank"}
<style>
div.blue { background-color:#e6f0ff; border-radius: 5px; padding: 5px;}
</style>
<div class = "blue">
...
### [Test Your Understanding](https://docs.google.com/forms/d/e/1FAIpQLScdVWPJbKZrwQq7hQfEh27ga9gva7PvxOmE7WfD6X2hkJx61Q/viewform?usp=dialog){target="_blank"}
<style>
div.blue { background-color:#e6f0ff; border-radius: 5px; padding: 5px;}
</style>
<div class = "blue">
...
### [Test Your Understanding](https://docs.google.com/forms/d/e/1FAIpQLSdbjaxaFCB6iRYKFXImgzXW22hRrcswY78iilyuwSCn25SrLg/viewform?usp=dialog){target="_blank"}
<style>
div.blue { background-color:#e6f0ff; border-radius: 5px; padding: 5px;}
</style>
<div class = "blue">
...
## [Lab Practical Practice](https://docs.google.com/forms/d/e/1FAIpQLSe90-3YEijIRg3lo5JzYM6R9L_O6ozrhNQzPUcAGcbDPtVGdQ/viewform?usp=dialog){target="_blank"}
